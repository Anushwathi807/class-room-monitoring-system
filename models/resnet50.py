...
def load_weights(model: Model):
    """
    Loading pre-trained weights for the Face detection model
    Args:
        model (Model): face-detection model structure with randon weights
    Returns:
...
def build_model() -> Model:
    """
    Building Resnet-50 model for face detection
    """
